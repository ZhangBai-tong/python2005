      ...
      <div class="course-info">
        ...
        <div class="wrap-right">
          ...
          <div class="sale-time">
            ...
            <p class="expire">距离结束：仅剩 {{Math.floor(course.active_time/86400)}}天
              {{ Math.floor(course.active_time % 86400/3600) }}小时 {{Math.floor(course.active_time%86400%3600/60)}}分
              <span class="second">{{Math.floor(course.active_time%86400%3600%60)}}</span>秒</p>
          </div>
  ...
  methods: {
    ...
    add_cart() {
      ...
      this.$axios.post(this.$settings.HOST + 'cart/option/', {
        ...
        console.log(1111,res.data.cart_length);
      }).catch(error => {
    ...
    get_course_chapter() {
      console.log(185185)
      this.$axios({
        url: this.$settings.HOST + `course/chapters/?course=${this.course_id}`,
