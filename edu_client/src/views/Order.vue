<template>
  <div class="cart">
    <Header/>
    <div class="cart-info">
      <h3 class="cart-top">购物车结算 <span>共{{}}门课程</span></h3>
      <div class="cart-title">
        <table>
          <tr>
            <td class="t1" width="400px">课程</td>
            <td class="t1" width="400px">有效期</td>
            <td class="t1" width="400px">价格</td>
          </tr>

        </table>
      </div>
      <!--      <div class="cart-item" v-for="(course, index) in course_list" :key="index">-->
      <!--        <el-row>-->
      ...
      <div class="cart-item" v-for="(course, index) in course_list" :key="index">
        <el-row>
          ...
          <el-col :span="4" class="course-price" id="course_price">原价：¥{{ course.price }}</el-col>
          <el-col :span="4" class="course-price">现价：¥{{ course.final_price }}</el-col>
        </el-row>
      </div>
      <div class="calc">
          <el-row class="pay-row">
            ...
            <el-col :span="8">
              ...
              <!--            <span class="alipay"><img src="../static/image/alipay.png" alt=""></span>-->
